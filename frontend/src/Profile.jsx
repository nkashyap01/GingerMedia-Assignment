  ...
  return (
    <div className="min-h-screen flex justify-center items-center">
      {isUpdate ? (
          ...
          <div className="flex justify-center items-center w-full">
            <div>
              <h3 className="font-bold text-center">
                Name : <span className="text-[#FF6702]">{data.name}</span>
              </h3>
              <p className="font-bold text-center">
                Contact me :{" "}
                <span className="text-[#FF6702]">{data.contact}</span>
              </p>
              <p className="font-bold text-center">
                Date of Birth :{" "}
                <span className="text-[#FF6702]">{data.dob}</span>
              </p>
              <p className="font-bold text-center">
                Gmail : <span className="text-[#FF6702]">{data.email}</span>
              </p>

              <p className="text-center bg-slate-200 p-2 mt-2 text-sm mx-2">
                <span className="text-[#FF6702] font-bold">About me : </span>{" "}
                {data.discription}
              </p>

              <button
                className="w-full px-2 hover:bg-[#e76854] bg-[#FF6702] font-bold text-white mt-2 py-1 rounded-sm"
                onClick={() => handleClick()}
              >
                Update detail
              </button>
        ...
        <div className="bg-shadow p-2 -mt-10">
          ...
          <div>
            <input
              ...
              className="text-center rounded-sm border-2 p-1 m-1 placeholder-[#1A1A1A] focus:outline-[#FF6702] mb-2 w-60 relative ml-4"
              type="date"
              value={dob}
            />
          </div>
          ...
          <button
            className="w-full hover:bg-[#e76854] px-2 rounded-sm py-1 bg-[#FF6702] font-bold text-white"
            onClick={() => {
              handleClick();
              handleUpdate();
            }}
